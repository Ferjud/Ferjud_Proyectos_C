...
void restardiafecha(int, int, int,int);
...
int main() {
    ...
    if (validarfechas(dias, meses, años) == 1) 
    {
        ...
        printf("ingrese n dias a restar: \n");
        scanf(" %d",&n);
       
        restardiafecha(dias, meses, años,n);
    } 
    else 
    {
...
void restardiafecha(int diaresta, int mesresta, int añoresta,int n)
 {
    diaresta= diaresta - n;
