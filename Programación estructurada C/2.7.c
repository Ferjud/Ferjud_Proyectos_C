...
int main()
{
 int vcodigo[20], mcant[20][12]={{0}},mrec,i,cod,cp,día;
 float mpr[20][12]={{0}}, vprecio[20],precio;
 int cu,mes,s;
 float rectrimestral0_3,rectrimestral3_6, rectrimestral6_9, rectrimestral9_12;
 ...
 while(cp!=0)
 {
   ...
   for(i=0;i<20;i++)
   {
    ...
    for(i=0;i<20;i++)
    {
     ...
     rectrimestral0_3=rectrimestre(matpr,0,3);
     
     rectrimestral3_6=rectrimestre(matpr,3,6);
     
     rectrimestral6_9=rectrimestre(matpr,6,9);
     
     rectrimestral9_12=rectrimestre(matpr,9,12);
     
   
     if(rectrimestral0_3>rectrimestral3_6 && rectrimestral3_6>rectrimestral6_9 && rectrimestra)6_9>rectrimestral9_12)
     {
